    ...
    class Template {
        ...
        private function build_navigation($tree, $path, $current_url, $base_page, $mode) {
            ...
            foreach ($tree->value as $node) {
            	$url = $node->uri;
                if ($node->type === \TodayMade\Todaymade\Daux\Directory_Entry::FILE_TYPE) {
        ...
        <div class="container-fluid fluid-height wrapper">
            <div class="navbar navbar-fixed-top hidden-print">
                <div class="container-fluid">
                    ...
                    <a class="brand navbar-brand pull-left" href="<?php echo $index;?>"><?php if ($params['logo']) echo '<img class="logo-image" src="' . $params['logo'] . '" alt="' . $project_title . '">'; ?><?php echo $project_title; ?></a>
                </div>
            </div>
